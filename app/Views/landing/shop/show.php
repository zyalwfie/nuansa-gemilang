...
<section class="py-5">
    <div class="container px-4 px-lg-5 my-5">
        <div class="row gx-4 gx-lg-5 align-items-center">
            <div class="col-md-6"><img class="card-img-top mb-5 mb-md-0" src="<?= base_url() ?>/img/uploads/main/<?= $product['image'] ?>" alt="<?= $product['name'] ?>" /></div>
            <div class="col-md-6">
                ...
                <?php else : ?>
                    ...
                    <div class="form-group">
                        <input class="form-control text-center me-3 <?= session('not_in_stock') ? 'is-invalid' : '' ?>" type="num" value="<?= old('quantity', 1) ?>" name="quantity" style="max-width: 5rem" />
                    </div>
